    ...
    def draw_battle_visuals(self, battle_visuals, camera):
        ...
        for se in battle_visuals.siege_engines:
            ...
            if -50 < sx < SCREEN_WIDTH + 50 and -50 < sy < SCREEN_HEIGHT + 50:
                ...
                pygame.draw.rect(self.screen, (max(0, se.color[0] - 30),
                                                max(0, se.color[1] - 30),
                                                max(0, se.color[2] - 20)),
                                (int(sx) - pw // 2, int(sy) - ph // 2, pw, ph), 2)
                # Label
                ...
                # Firing flash
                if se.firing:
                    flash = pygame.Surface((pw + 8, ph + 8), pygame.SRCALPHA)
                    flash.fill((255, 200, 50, 60))
                    self.screen.blit(flash, (int(sx) - pw // 2 - 4,
                                              int(sy) - ph // 2 - 4))
