...
CLASSES = {
    ...
    "Wizard": {
        ...
        "spell_list": ["Fire Bolt", "Magic Missile", "Shield", "Burning Hands",
                       "Detect Magic", "Mage Armor", "Scorching Ray", "Misty Step",
...
MONSTERS = {
    ...
    "wraith":       {"hp": 67,  "ac": 13, "damage": 18, "speed": 2.5, "xp": 180, "cr": 5,
                     "type": "undead", "color": (80, 80, 120), "biomes": ["floor", "swamp"],
                     "drops": [("Soul Gem", 0.4), ("Ancient Relic", 0.3)]},
    "vampire":      {"hp": 144, "ac": 16, "damage": 20, "speed": 2.0, "xp": 390, "cr": 7,
                     "type": "undead", "color": (120, 20, 30), "biomes": ["floor", "forest", "dense_forest"],
    ...
    "donkey":       {"hp": 18,  "ac": 10, "damage": 2,  "speed": 1.5, "xp": 5,   "cr": 0,
                     "type": "beast", "color": (130, 120, 110), "biomes": ["grass", "farmland"],
                     "drops": [("Raw Meat", 0.6), ("Leather", 0.4)],
                     "passive": True},
    "dog":          {"hp": 12,  "ac": 10, "damage": 4,  "speed": 2.5, "xp": 5,   "cr": 0.125,
                     "type": "beast", "color": (150, 120, 80), "biomes": ["grass", "farmland"],
                     "drops": [("Raw Meat", 0.4)],
                     "passive": True},
    "cat":          {"hp": 5,   "ac": 12, "damage": 1,  "speed": 2.0, "xp": 2,   "cr": 0,
...
def random_npc_class_and_race() -> Tuple[str, str]:
    ...
    # Weight toward common classes
    class_weights = {
        "Fighter": 15, "Cleric": 10, "Rogue": 10, "Ranger": 8, "Wizard": 7,
        "Bard": 7, "Paladin": 5, "Druid": 5, "Barbarian": 5, "Monk": 4,
        "Sorcerer": 4, "Warlock": 3,
    }
